...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    reports: {
      ...
      typeTitle: 'Session focus',
      highlights: 'Highlights & Progress',
      highlightsPlaceholder: 'Wins, new friendships, good lab submissions...',
      concerns: 'Challenges & Needs',
      concernsPlaceholder: 'Who needs academic support or tutoring? Your observations.',
      chooseAssignment: 'Recommended Action',
      submitDSEW: 'Save Note',
      pastReports: 'Saved Notes',
      analyticsTitle: 'Mentorship Progress Analytics',
      sentimentOverview: 'Adaptation & Progress Overview'
    },
    profile: {
      title: 'Profile',
  ...
  ru: {
    ...
    reports: {
      ...
      dueIn: 'Период: Осенний семестр 2026',
      desc: 'Заметки и качественная аналитика по твоей группе. Прогресс и адаптация первокурсников.',
      typeTitle: 'Направление встречи',
      highlights: 'Главные успехи и позитивные моменты',
      highlightsPlaceholder: 'Успехи на лабах, новые связи, участие в клубах...',
      concerns: 'Трудности и академические вопросы',
      concernsPlaceholder: 'Кому нужна помощь с высшматом или программированием?',
      chooseAssignment: 'Рекомендованные действия',
      submitDSEW: 'Сохранить заметку',
      pastReports: 'Архив заметок',
      analyticsTitle: 'Аналитика прогресса подопечных',
  ...
  kz: {
    ...
    reports: {
      title: 'Апталық есеп',
      dueIn: 'Кезең: Күзгі семестр 2026',
      desc: 'Тобыңыз бойынша жазбалар мен сапалық талдау. Бірінші курс студенттерінің бейімделуі.',
      typeTitle: 'Кездесу бағыты',
      highlights: 'Осы кезеңнің басты жетістіктері',
      highlightsPlaceholder: 'Жетістіктер, жаңа достар, белсенді студенттер...',
      concerns: 'Қауіптер мен академиялық сұрақтар',
      concernsPlaceholder: 'Кімге оқу бойынша көмек қажет? Шынайы пікір.',
      chooseAssignment: 'Іс-қимыл жоспары',
      submitDSEW: 'Жазбаны сақтау',
      pastReports: 'Бұрынғы жазбалар мұрағаты',
      analyticsTitle: 'Студенттердің бейімделу талдауы',
